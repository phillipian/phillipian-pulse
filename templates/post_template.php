...
<?php $item = $data->get_item($i); ?> 
	...
	<?php if(substr($item->get_link(), 0, 18) == "http://twitter.com"): ?>
			<div class="post twitter rounded">
				...
				<div class="content"><div class="profile-image"><a href="http://twitter.com/<?php echo $username?>"><img src="http://api.twitter.com/1/users/profile_image?screen_name=<?php echo $username?>&size=bigger"></a></div><p><?php echo linkify(substr($item->get_title(), strlen($username)+2)) ?></p></div>
	...
	<div class="post photo rounded">
		<div class="post-top"><span class="time"><?php echo date("g:ia",strtotime($item->get_date()));?></span> - <?php echo $item->get_feed()->get_title()?> Photo <?php if($type !== 'pulse_posts'): ?><a class="filter" href="posts.php?type=<?php echo $account; ?>">View just <?php echo $item->get_feed()->get_title()?></a><?php endif;?></div>
		<div class="content">
			<?php echo $item->get_content()?>
		</div>
		<div class="post-bottom"><a class="comment-link" href="../<?php echo $item->get_link()?>#disqus_thread" name="<?php echo $item->get_link()?>">Comments</a><a href="#hide-comments" class="hide-comments">Hide Comments</a><div id="fb-root"></div><fb:like href="<?php echo $item->get_link()?>" send="true" layout="button_count" width="120px" show_faces="false" font=""></fb:like></div>
	...
	<div class="post standard rounded">
		<div class="post-top"><span class="time"><?php echo date("g:ia",strtotime($item->get_date()));?></span> - <?php echo $item->get_feed()->get_title()?>  <?php if($type !== 'pulse_posts'): ?><a class="filter" href="posts.php?type=<?php echo $account; ?>">View just <?php echo $item->get_feed()->get_title()?></a><?php endif;?></div>
		<div class="content">
			<?php echo $item->get_content()?>
		</div>
		<div class="post-bottom"><a class="comment-link" href="../<?php echo $item->get_link()?>#disqus_thread" name="<?php echo $item->get_link()?>">Comments</a><a href="#hide-comments" class="hide-comments">Hide Comments</a><div id="fb-root"></div><fb:like href="<?php echo $item->get_link()?>" send="true" layout="button_count" width="120px" show_faces="false" font=""></fb:like></div>
